...
Runtimes report estimation plus covariance on one logical CPU. A dagger marks a clearly inferior final log likelihood; its runtime is retained but its estimate is excluded from consistency.
