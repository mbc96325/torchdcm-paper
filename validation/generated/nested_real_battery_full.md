...
## Excluded attempted nested specifications

- Telephone service, ModeCanada, NOx, RiskyTransport, Car, Game, and Game2 were attempted but not included in the paper table because the aligned Biogeme solution was unavailable, numerically unstable, timed out, or the data did not encode one chosen alternative per observation under the current benchmark conversion.
