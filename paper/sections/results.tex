...
The table now includes all real-data cases for which we define an interpretable nested-logit specification: Swissmetro, LPMC London, NHTS 2022, and Parking Spain, plus the Swissmetro cross-nested row.
