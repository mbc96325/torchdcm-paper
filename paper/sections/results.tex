...
All rows are consistent with Biogeme under the prespecified likelihood, parameter, and probability tolerances.
Nested-logit specifications that do not produce a stable aligned Biogeme solution are not forced into the table; this excludes, for example, the telephone nested split, ModeCanada, NOx, RiskyTransport, and game-style datasets under the current benchmark definitions.
