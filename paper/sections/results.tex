...
Rows with an available Biogeme reference are consistent with Biogeme under the prespecified likelihood, parameter, and probability tolerances.
Attempted nested-logit specifications that do not produce a stable aligned result are still listed with NA entries, including Telephone service, ModeCanada, NOx, RiskyTransport, Train, Car, Game, and Game2.
