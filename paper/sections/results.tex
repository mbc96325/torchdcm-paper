...
The Swissmetro nested-logit row is compared with both Biogeme and Apollo.
The cross-nested row is currently compared with Biogeme under fixed allocation weights and common nest constraints.
Both rows are consistent under the prespecified tolerance rule.
